...
SECRET_KEY = 'django-insecure-glvi0jdjttdb&g*t&!nknu%+7(*w-m*mpb*vdiuuggc*+v9s-k'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '172.28.80.1', 'host.docker.internal']
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'root',
        'HOST': 'db',
        'PORT': '3306', # We used the docker container port for the database?
    }
}
...
# Assigning AUTH_USER_MODEL to CustomUser
